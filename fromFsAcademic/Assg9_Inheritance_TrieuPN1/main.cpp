...
int main()
{
    ...
    cout << F << endl;
    cout << "*************** DISTANCE *************" << endl;
    cout << "Distance form A to B: " << distance(A,B) << endl;
    cout << "Distance form C to D: " << distance(C,D) << endl;
    double dot = dotProduct(A,B);
    double dot2 = dotProduct(A,B,C);
    double dot3 = dotProduct(A,B,C,D);
    cout << "2 vectors from O(0,0) to A and B -- A*B - (O(0,0)): " << dot << endl;
    cout << "2 vectors from A(Ax,Ay) to B and C --  AB*AC - (A(Ax,Ay)): " << dot2 << endl;
    cout << "2 vectors from 4 poins (A,B,C,D) -- AB*CD - (O(0,0)): " << dot3 << endl;
    cout << endl << endl;
